...
<div class="form-group">
  ...
  <input type="text" name="name" id="name" class="form-control" data-rule-required=true placeholder="{{ trans('inoplate-account::labels.name') }}" value="{{ old('name', $user['description']['name']) }}">
